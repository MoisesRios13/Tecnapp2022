            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> Editar Docente
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Lista de Docentes</a></li>
                        ...
                        <form class="row g-3" action="{{route('school.teacher.update')}}" method="POST">
                            ...
                            <div class="col-2">
                                ...
                                <select id="inputState" class="form-select" name="gender" required>
                                    <option value="Male" {{($teacher->gender == 'Masculino')?'selected':null}}>Masculino</option>
                                    <option value="Female" {{($teacher->gender == 'Femenino')?'selected':null}}>Femenino</option>
                                </select>
                            </div>
                            <div class="col-3">
