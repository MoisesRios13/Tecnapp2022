                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            @elseif(\App\Models\SchoolSession::latest()->count() > 0)
                                <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Sesión Académica Actual {{$current_school_session_name}}</a>
                            @else
                                <a class="nav-link text-danger disabled" href="#" tabindex="-1" aria-disabled="true"><i class="bi bi-exclamation-diamond-fill me-2"></i> Crear una sesión académica.</a>
                            @endif
                        </li>
                    </ul>
                    @endauth
