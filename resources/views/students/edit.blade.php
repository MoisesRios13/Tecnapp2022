                ...
                <div class="col ps-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Lista del Estudiante</a></li>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-2">
                                    ...
                                    <select id="inputBloodType" class="form-select" name="blood_type" required>
                                        ...
                                        <option value="AB-" {{($student->blood_type == 'AB-')?'selected':null}}>AB-</option>
                                        <option value="Other" {{($student->blood_type == 'Other')?'selected':null}}>Otro</option>
                                    </select>
                                </div>
                                <div class="col-2">
                                    ...
                                    <select id="inputReligion" class="form-select" name="religion" required>
                                        <option {{($student->religion == 'Catolico')?'selected':null}}>Catolico</option>
                                        <option {{($student->religion == 'Cristiano')?'selected':null}}>Cristiano</option>
                                        <option {{($student->religion == 'Evangelico')?'selected':null}}>Evangelico</option>
                                        <option {{($student->religion == 'Budista')?'selected':null}}>Budista</option>
                                        <option {{($student->religion == 'Protestante')?'selected':null}}>Protestante</option>
                                        <option {{($student->religion == 'Otro')?'selected':null}}>Otro</option>
                                    </select>
                                </div>
                                <div class="col-3">
