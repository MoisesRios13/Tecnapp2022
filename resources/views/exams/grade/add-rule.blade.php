...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Agregar regla de calificación</h1>
                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border bg-light">
                                <form action="{{route('exam.grade.system.rule.store')}}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <label for="inputPoint" class="form-label">Punto<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                        <input type="number" step="0.01" name="point" class="form-control" id="inputPoint" placeholder="3.5, 4.0, ...">
                                    </div>
                                    <div class="mt-2">
                                        <label for="inputGrade" class="form-label">Grado<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    ...
                                    <button type="submit" class="mt-3 btn btn-sm btn-outline-primary"><i class="bi bi-plus"></i> Agregar</button>
                                </form>
                            </div>
                        </div>
                    </div>
