...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Editar regla de examen</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Reglas de examen</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Editar regla de examen</li>
                        </ol>
                    </nav>
                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('exam.rule.update')}}" method="POST">
                                    ...
                                    <button type="submit" class="mt-3 btn btn-sm btn-outline-primary"><i class="bi bi-check"></i> Guardar</button>
                                </form>
                            </div>
                        </div>
                    </div>
