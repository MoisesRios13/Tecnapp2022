            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-journal-medical"></i> Mis Cursos
                    </h1>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-calendar2-week me-2"></i> Tomar Asistencia</a></li>
                                                      <li><a href="{{route('attendance.list.show', [
                                                        ...
                                                        'section_name' => $course->section->section_name,
                                                        'course_name' => $course->course->course_name
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-calendar2-week-fill me-2"></i> Ver Asistencia</a></li>
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-file-post me-2"></i> Crear Tarea</a></li>
                                                      <li><a href="{{route('assignment.list.show', ['course_id' => $course->course->id])}}" role="button" class="dropdown-item"><i class="bi bi-file-post-fill me-2"></i> Ver Tareas</a></li>
                                                    ...
                                                    <li><a href="{{route('course.mark.list.show', [
                                                        ...
                                                        'course_name' => $course->course->course_name,
                                                        'semester_id' => $selected_semester_id
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-cloud-sun me-2"></i> Ver resultados finales</a></li>
