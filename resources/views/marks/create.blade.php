                ...
                <div class="col ps-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Establecer Marks</li>
                        </ol>
                    </nav>
                    @include('session-messages')
                    @if ($academic_setting['marks_submission_status'] == "on")
                    <p class="text-primary">
                        <i class="bi bi-exclamation-diamond-fill me-2"></i> La ventana de envío de marcas está abierta ahora.
                    </p>
                    @endif
                    <p class="text-primary">
                        <i class="bi bi-exclamation-diamond-fill me-2"></i> La presentación de calificaciones finales debe realizarse solo una vez en un semestre cuando la ventana de presentación de calificaciones está abierta.
                    </p>
                    @if ($final_marks_submitted)
                    <p class="text-success">
                        <i class="bi bi-exclamation-diamond-fill me-2"></i> Se envían notas.
                    </p>
                    @endif
                    ...
                    <form action="{{route('course.mark.store')}}" method="POST">
                        ...
                        {{-- <div class="row justify-content-between mb-3"> --}}
                            ...
                            @else
                                ...
                                <div class="col-5">
                                    <p class="text-success">
                                        <i class="bi bi-exclamation-diamond-fill me-2"></i> Ha enviado calificaciones finales <i class="bi bi-stars"></i>.
                                    </p>
                                </div>
                                @else
                                <div class="col-5">
                                    <p class="text-primary">
                                        <i class="bi bi-exclamation-diamond-fill me-2"></i> Crear examen para dar notas.
                                    </p>
                                </div>
                                @endif
                            @endif
                            {{-- <div class="col-3">
                                <button type="button" class="btn btn-outline-primary"><i class="bi bi-check2"></i> Enviar Marks</button>
                            </div> --}}
                        {{-- </div> --}}
                    </form>
                </div>
