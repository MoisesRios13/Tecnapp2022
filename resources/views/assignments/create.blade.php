            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-file-post"></i> Crear tarea
                    </h1>
                        ...
                        <div class="col-5">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('assignment.store')}}" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="assignment-name" class="form-label">Nombre de la tarea</label>
                                        <input type="text" class="form-control" id="assignment-name" name="assignment_name" placeholder="Assignment Name" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="assignment-file" class="form-label">Archivo de la tarea</label>
                                    ...
                                    <div class="mb-4">
                                        <button type="submit" class="btn btn-outline-primary"><i class="bi bi-check2"></i> Crear</button>
                                    </div>
                                </form>
                            </div>
                        </div>
