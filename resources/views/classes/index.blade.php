                                    ...
                                    <div class="card my-3">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade" id="class{{$school_class->id}}-syllabus" role="tabpanel">
                                                    ...
                                                    <table class="table table-borderless">
                                                        <thead>
                                                        <tr>
                                                            <th scope="col">Nombre Syllabus</th>
                                                        ...
                                                        @foreach ($school_class->syllabi as $syllabus)
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{asset('storage/'.$syllabus->syllabus_file_path)}}" role="button" class="btn btn-sm btn-outline-primary"><i class="bi bi-download"></i> Descarga</a>
                                                                </div>
                                                            </td>
                                                            </tr>
                                                        @endforeach
                                        ...
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                            @isset($total_sections)
                                                <span>Secciones Totales: {{$total_sections}}</span>
                                            @endisset
                                            @can('edit classes')
